...
<body class="bg-gray-100 font-sans antialiased">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <label for="stok_tambahan" class="block text-xs text-gray-500 mt-3 mb-1">Jumlah restock (tambahan)</label>
                                        ...
                                        <div class="mt-2 flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-lg px-3 py-2">
                                            ...
                                            <span class="text-xs text-gray-600">Total stok akhir:</span>
                                            <span id="stok_total" class="text-sm font-bold text-orange-600">{{ old('stok', $book->stok) + old('stok_tambahan', 0) }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
    ...
    <script>
        ...
        function updateTotal() {
            ...
            const tambahan = parseInt(document.getElementById('stok_tambahan').value || 0);
            document.getElementById('stok_total').textContent = stok + tambahan;
        }
    </script>
