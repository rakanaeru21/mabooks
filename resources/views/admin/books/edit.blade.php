            ...
            <main class="flex-1 p-6 lg:p-8">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden max-w-3xl">
                    <div class="px-6 py-5 border-b border-gray-100">
                        <h2 class="font-bold text-gray-900">Edit Informasi Buku</h2>
                        <p class="text-sm text-gray-500 mt-1">Perbarui detail buku</p>
                    </div>

                    <form method="POST" action="{{ route('admin.books.update', $book) }}" enctype="multipart/form-data" class="p-6 space-y-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                @if ($book->cover)
                                <img src="{{ asset('storage/' . $book->cover) }}" alt="{{ $book->judul }}" class="w-16 h-20 object-cover rounded-lg border border-gray-200" id="cover-preview">
                                @else
